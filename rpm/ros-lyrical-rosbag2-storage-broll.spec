...
%global pkg_name rosbag2_storage_broll
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-rosbag2-storage-broll
Version:        0.1.0
Release:        3%{?dist}
...
%description
Rosbag2 storage plugin to play audio/video files as ROS messages using B-Roll
tools
...
%changelog
* Wed Apr 29 2026 Emerson Knapp <emerson.knapp@bonsairobotics.ai> - 0.1.0-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Emerson Knapp <emerson.knapp@bonsairobotics.ai> - 0.1.0-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Emerson Knapp <emerson.knapp@bonsairobotics.ai> - 0.1.0-1
- Autogenerated by Bloom
