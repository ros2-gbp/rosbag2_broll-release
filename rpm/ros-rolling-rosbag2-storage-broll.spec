...
Summary:        ROS rosbag2_storage_broll package

License:        Apache License 2.0
Source0:        %{name}-%{version}.tar.gz

Requires:       ros-rolling-broll
...
BuildRequires:  ros-rolling-broll
...
%changelog
* Thu May 01 2025 Emerson Knapp <emerson.knapp@bonsairobotics.ai> - 0.1.0-1
